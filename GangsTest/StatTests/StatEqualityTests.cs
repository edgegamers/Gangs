...
public class StatEqualityTests {
  ...
  public async void Stat_Equality_SameEverything(IStatManager mgr) {
  ...
  [Theory]
  [ClassData(typeof(StatManagerData))]
  public async void Stat_Equality_DiffName(IStatManager mgr) {
    var foo1 = await StatTestUtil.CreateStat(mgr);
  ...
  [Theory]
  [ClassData(typeof(StatManagerData))]
  public async void Stat_Equality_DiffDesc(IStatManager mgr) {
    var foo1 = await StatTestUtil.CreateStat(mgr);
  ...
  [Theory]
  [ClassData(typeof(StatManagerData))]
  public async void Stat_Equality_DiffBoth(IStatManager mgr) {
    var foo1 = await StatTestUtil.CreateStat(mgr);
  ...
  [Theory]
  [ClassData(typeof(StatManagerData))]
  public async void Stat_Equality_DiffIDs(IStatManager mgr) {
